...
<View style={styles.section}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("tintoChile")}>
...
<TouchableOpacity onPress={() => navigation.navigate("roseChile")}>
           <View style={styles.box}>
        <Image
          source={{
...
<TouchableOpacity onPress={() => navigation.navigate("brancoChile")}>
   <View style={styles.box}>
        <Image
          source={{
...
<TouchableOpacity onPress={() => navigation.navigate("KitsChile")}>
        <View style={styles.box}>
        <Image
          source={{
