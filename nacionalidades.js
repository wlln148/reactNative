...
const MinhaTela = ({ navigation }) => {
  ...
  <ScrollView showsVerticalScrollIndicator={false}>
   ...
   <View style={styles.container2}>
        <TouchableOpacity onPress={() => navigation.navigate("tiposArgentino")}>
          ...
          <Text style={styles.textoSobreImagem}>Argentina</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.container3}>
        <TouchableOpacity onPress={() => navigation.navigate("tiposChile")}>
          <View style={styles.imagem2}>
            <Image
              source={{ 
          ...
          <Text style={styles.textoSobreImagem}>Chile</Text>
        </TouchableOpacity>
      </View> 

  <View style={styles.container4}>
        <TouchableOpacity onPress={() => navigation.navigate("tiposUruguai")}>
          <View style={styles.imagem2}>
            <Image
              source={{ 
                uri: 'https://images.unsplash.com/photo-1598152541316-921ebb5e0433?auto=format&fit=crop&q=80&w=1470&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
          ...
          <Text style={styles.textoSobreImagem}>Uruguai</Text>
        </TouchableOpacity>
      </View> 

        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("origem")}>
