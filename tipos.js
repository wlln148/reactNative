...
<View style={styles.section}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("TintoBrasil")}>
...
<TouchableOpacity onPress={() => navigation.navigate("RoseBrasil")}>
           <View style={styles.box}>
        <Image
          source={{
...
<TouchableOpacity onPress={() => navigation.navigate("BrancoBrasil")}>
   <View style={styles.box}>
        <Image
          source={{
...
<TouchableOpacity onPress={() => navigation.navigate("KitsBrasil")}>
        <View style={styles.box}>
        <Image
          source={{
