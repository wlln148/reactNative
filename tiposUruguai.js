...
<View style={styles.section}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("tintoUruguai")}>
...
<TouchableOpacity onPress={() => navigation.navigate("roseUruguai")}>
           <View style={styles.box}>
        <Image
          source={{
...
<TouchableOpacity onPress={() => navigation.navigate("brancoUruguai")}>
   <View style={styles.box}>
        <Image
          source={{
...
<TouchableOpacity onPress={() => navigation.navigate("kitsUruguai")}>
        <View style={styles.box}>
        <Image
          source={{
